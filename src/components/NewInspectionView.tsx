  ...
  const handleStartAnalysis = async () => {
    ...
    try {
      ...
      const detectedCommodity =
        resData.commodityName || commodityName || 'Pre-Packaged Nutrition Cookies';
      const detectedBrand = resData.brand || 'SunHarvest Premium';
      const detectedMfg = resData.manufacturer || 'SunHarvest Agro Industries Pvt. Ltd.';
      const detectedMfgAddr =
        resData.mfgAddress || 'Plot 88, Food Industrial Park, Kundli, Haryana - 131028';
      const detectedOrigin = resData.countryOfOrigin || 'India';
      const detectedNetQty = resData.netQuantity || '400 g';
      const detectedMrp = resData.mrp || '₹ 160.00 (inclusive of all taxes)';
      const detectedUsp = resData.unitSalePrice || '₹ 0.40 per g';
      const detectedMfgDate = resData.mfgDate || '08/2026';
      const detectedExpDate = resData.expiryDate || '02/2027';
      const detectedCare =
        resData.consumerCare || 'Care Exec: 1800-11-8899 | support@sunharvest.in | Plot 88 Kundli';
      ...
      // Declarations audit list
      const extractedDeclarations: DeclarationField[] = [
        {
          id: 'd-1',
          fieldName: 'Name and Address of Manufacturer',
          ruleReference: 'Rule 6(1)(a)',
          extractedValue: `${detectedMfg}, ${detectedMfgAddr}`,
          status: 'passed',
          confidence: 0.98,
          legalNote: 'Complete postal address with PIN code verified.',
        },
        {
          id: 'd-2',
          fieldName: 'Generic Commodity Name',
          ruleReference: 'Rule 6(1)(b)',
          extractedValue: detectedCommodity,
          status: 'passed',
          confidence: 0.99,
        ...
        },
        {
          ...
          legalNote: 'Standard symbol "g" used. Font height conforms to Table I (Rule 7).',
        },
        {
          id: 'd-4',
          fieldName: 'Month and Year of Manufacture / Packing',
          ruleReference: 'Rule 6(1)(d)',
          extractedValue: `Mfg: ${detectedMfgDate} | Expiry: ${detectedExpDate}`,
          status: 'passed',
          confidence: 0.96,
          legalNote: 'Standard MM/YYYY format compliant with PCR 2011.',
        },
        {
          id: 'd-5',
          ...
          status: 'passed',
          confidence: 0.98,
          legalNote: 'Mandatory phrase "inclusive of all taxes" present.',
        },
        {
          id: 'd-6',
          fieldName: 'Unit Sale Price (USP)',
          ruleReference: 'Rule 6(11)',
          extractedValue: detectedUsp,
          status: detectedUsp ? 'passed' : 'violation',
          confidence: 0.95,
          legalNote: 'Mandatory for packages > 200g under 2021/2022 amended PCR rules.',
        },
        {
          id: 'd-7',
          ...
          status: 'passed',
          confidence: 0.99,
          legalNote: 'Mandatory declaration verified.',
        },
        {
          id: 'd-8',
          fieldName: 'Consumer Care / Grievance Redressal',
          ruleReference: 'Rule 6(1)(g)',
          extractedValue: detectedCare,
          status: 'passed',
          confidence: 0.96,
          legalNote: 'Name, address, phone helpline, and email ID present.',
        },
      ];
      ...
      // Compliance Findings
      const extractedFindings: ComplianceFinding[] = [
        {
          id: 'f-1',
          ...
          explanation: 'No missing mandatory fields, correct font sizing, and valid Unit Sale Price declaration.',
